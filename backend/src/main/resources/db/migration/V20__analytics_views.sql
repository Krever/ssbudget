...
-- Small key/value table for state the app owns about the analytics instance — chiefly the marker
-- saying the canonical dashboard has been seeded, so it is never re-applied over the user's edits.
